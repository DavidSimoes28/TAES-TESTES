...
Mobile.setText(findTestObject('AT2/android.widget.EditText0'), 'qwerty', 0)

Mobile.setText(findTestObject('AT2/android.widget.EditText0 (1)'), '123123', 0)

Mobile.tap(findTestObject('AT2/android.widget.Button0 - LOGIN (1)'), 0)
