...
Mobile.tap(findTestObject('Button - Deactivate Account Profile'), 0)

Mobile.tap(findTestObject('Button - No Profile'), 0)

Mobile.tap(findTestObject('Button - Deactivate Account Profile'), 0)

Mobile.tap(findTestObject('Button - Yes Profile'), 0)
