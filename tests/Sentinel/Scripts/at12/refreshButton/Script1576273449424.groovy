...
Mobile.tap(findTestObject('Button - Refresh Dashboard'), 0)

Mobile.tap(findTestObject('TextView - Data Refresh Dashboard'), 0)
...
Mobile.tap(findTestObject('Button - Refresh Dashboard Auth'), 0)

Mobile.tap(findTestObject('TextView - Data Refresh Dashboard Auth'), 0)
