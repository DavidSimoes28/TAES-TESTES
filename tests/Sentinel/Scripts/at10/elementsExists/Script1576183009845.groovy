...
Mobile.tap(findTestObject('at10/android.widget.FrameLayout0'), 0)

Mobile.tapAndHold(findTestObject('Button - Favorite Dashboard Auth'), 0, 0)

Mobile.verifyElementExist(findTestObject('ListView - Favorites'), 0)

Mobile.tap(findTestObject('ListTextView - Favorite'), 0)

Mobile.tap(findTestObject('Button - No Popup'), 0)
