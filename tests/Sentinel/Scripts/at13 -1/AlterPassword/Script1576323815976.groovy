...
Mobile.setText(findTestObject('EditText - Old Password Profile'), '123123', 0)

Mobile.setText(findTestObject('EditText - New Password Profile'), '123123', 0)

Mobile.setText(findTestObject('EditText - Confirmation Password Profile'), '123123', 0)

Mobile.tap(findTestObject('Button - Alter Password Profile'), 0)

Mobile.tap(findTestObject('Button - Cancel Profile'), 0)
