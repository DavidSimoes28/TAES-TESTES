...
Mobile.verifyElementExist(findTestObject('at8/android.widget.Button0 - SEND (2)'), 0)

Mobile.verifyElementExist(findTestObject('at8/android.widget.Button0 - CANCEL'), 0)
