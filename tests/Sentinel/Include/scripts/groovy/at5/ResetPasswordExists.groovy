...
class ResetPasswordExists {
	...
	@Then("i can see if the {string} field exists")
	def I_forget_password_exists(String string) {
		Mobile.verifyElementExist(findTestObject('at5/android.widget.TextView0 - '+string), 0)
	}
}